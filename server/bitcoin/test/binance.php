...
console.log(fromTimestamp(1632068460)); // 2020-10-08T13:04:02.000Z
...
?>
    ...
    <body>
        <button class="btn-binance" onclick=" window.open('https://www.binance.com/ru/trade/BTC_USDT?layout=basic','_blank')">Binance</button>
